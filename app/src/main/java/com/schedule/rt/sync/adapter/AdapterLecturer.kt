...
class AdapterLecturer(
    ...
    private val onFirstClick: ((DataClassLecturer) -> Unit)? = null,
    private val onSecondClick: ((DataClassLecturer) -> Unit)? = null,
    private val ivNext: Int? = null,
    private val onNextClick: ((DataClassLecturer) -> Unit)? = null
    ...
    override fun onBindViewHolder(
        ...
        holder.ivItem.setImageResource(R.drawable.profile)
        ...
        vmMajor.getMajorByUid(currentItem.uidMajorManager).observe(lifecycleOwner) {
            holder.tvData3.text = it?.nameMajor ?: "-"
        }
        ...
        holder.ivNext.setImageResource(ivNext ?: R.drawable.next)
    ...
    fun updateData (newData: List<DataClassLecturer>) {
        dataClassLecturer.clear()
        dataClassLecturer.addAll(newData)

...
class AdapterMajor(
    ...
    private val onFirstClick: ((DataClassMajor) -> Unit)? = null,
    private val onSecondClick: ((DataClassMajor) -> Unit)? = null,
    private val onNextClick: ((DataClassMajor) -> Unit)? = null
): RecyclerView.Adapter<AdapterMajor.ViewHolder>() {

    var dataClassMajor = mutableListOf<DataClassMajor>()
    ...
    override fun onBindViewHolder(
        ...
        holder.ivItem.setImageResource(R.drawable.major)
    ...
    fun updateData(newDataClassMajor: List<DataClassMajor>) {

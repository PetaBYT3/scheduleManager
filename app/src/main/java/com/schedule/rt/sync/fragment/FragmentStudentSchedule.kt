...
import com.schedule.rt.sync.databinding.FragmentStudentScheduleBinding
...
class FragmentStudentSchedule : Fragment() {
    ...
    private fun recyclerView(
        ...
        vmUser.getUser().observe(viewLifecycleOwner) {
            ...
            vmSchedule.getScheduleForStudent(uidClasses, day).observe(viewLifecycleOwner) {

...
class AdapterClasses(
    ...
    private val onFirstClick: ((DataClassClasses) -> Unit)? = null,
    private val onSecondClick: ((DataClassClasses) -> Unit)? = null,
    private val onNextClick: ((DataClassClasses) -> Unit)? = null
): RecyclerView.Adapter<AdapterClasses.ViewHolder>() {

    var dataClassClasses = mutableListOf<DataClassClasses>()
    ...
    override fun onBindViewHolder(
        ...
        holder.ivItem.setImageResource(R.drawable.classes)
    ...
    fun updateData(newDataClassClasses: List<DataClassClasses>) {
